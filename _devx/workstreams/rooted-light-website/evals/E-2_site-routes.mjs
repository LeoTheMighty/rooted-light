#!/usr/bin/env node
// E-2: Full-site static build — all 7 routes present, global nav reaches
// every top-level section from every page. Covers G-2, G-4, CAP-1,
// CAP-6, FR-1, FR-11, UC-7. Runs against dist/ (any profile).
...
const ROUTES = [
  "", "about-me", "about-you", "resources",
  "offerings", "offerings/reiki", "offerings/therapy",
];
const NAV_SECTIONS = ["about-me", "about-you", "resources", "offerings"];
